...
def KNNpeptide(fastas, **kw):
	...
	return encodings
fastas = readFasta.readFasta(r"M_test.txt")
kw=  {'path': r"E:\丙二酰化位点————2\6月17号后\特征提取\KNN",'train':r"M_test.txt",'label':r"label_M_test.txt",'order':'ACDEFGHIKLMNPQRSTVWYO'}
